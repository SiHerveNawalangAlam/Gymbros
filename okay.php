            ...
            <div class="col">
              <div class="form-group">
                ...
                <div class="input-with-icon">
                  ...
                  <input type="date" name="birthdate" class="form-input" id="birthdate" required
        ...
        <div class="form-section">
          ...
          <div class="form-group">
            ...
            <select name="security_question1" class="form-input" required>
              ...
              <option value="Who is your best friend in Elementary?" <?php echo (isset($_POST['security_question1']) && $_POST['security_question1'] == 'Who is your best friend in Elementary?') ? 'selected' : ''; ?>>Who is
                your
                best friend in Elementary?</option>
              <option value="What is the name of your favorite pet?" <?php echo (isset($_POST['security_question1']) && $_POST['security_question1'] == 'What is the name of your favorite pet?') ? 'selected' : ''; ?>>What is
                the
          ...
          <div class="form-group">
            ...
            <select name="security_question2" class="form-input" required>
              <option value="">Select a question</option>
              <option value="Who is your best friend in Elementary?" <?php echo (isset($_POST['security_question2']) && $_POST['security_question2'] == 'Who is your best friend in Elementary?') ? 'selected' : ''; ?>>Who is
                your
                best friend in Elementary?</option>
              <option value="What is the name of your favorite pet?" <?php echo (isset($_POST['security_question2']) && $_POST['security_question2'] == 'What is the name of your favorite pet?') ? 'selected' : ''; ?>>What is
                the
                name of your favorite pet?</option>
          ...
          <div class="form-group">
            ...
            <select name="security_question3" class="form-input" required>
              <option value="">Select a question</option>
              <option value="Who is your best friend in Elementary?" <?php echo (isset($_POST['security_question3']) && $_POST['security_question3'] == 'Who is your best friend in Elementary?') ? 'selected' : ''; ?>>Who is
                your
                best friend in Elementary?</option>
              <option value="What is the name of your favorite pet?" <?php echo (isset($_POST['security_question3']) && $_POST['security_question3'] == 'What is the name of your favorite pet?') ? 'selected' : ''; ?>>What is
                the
                name of your favorite pet?</option>
